 ...
 */
@MultipartConfig
public class MarkChangeImageController extends HttpServlet {

    private static final String ERROR = "WEB-INF/error.jsp";
    private static final String UPLOAD_DIR = "uploads/marks";
    private static final String SUCCESS = "MarkEditController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at MarkChangeImageController: " + e.getMessage());
        } finally {
