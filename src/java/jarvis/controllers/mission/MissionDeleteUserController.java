 ...
 * @author Chris Tran
 */
public class MissionDeleteUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("ERROR", "Unable to remove avenger from mission");
        String url = ERROR;
        try {
            ...
            log("ERROR at MissionDeleteUserController: " + e.getMessage());
        } finally {
