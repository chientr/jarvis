...
public class UserEditController extends HttpServlet {
    ...
    private static final String HOME = "WEB-INF/user.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO dto = bean.getByUsername();
            request.setAttribute("DTO", dto);
            UserSearchDTO search = bean.getUserSearchDTO();
            request.setAttribute("SEARCH", search);
            url = HOME;
        } catch (Exception e) {
            log("ERROR at UserEditController: " + e.getMessage());
        } finally {
