...
<html>
    ...
    <body>
        ...
        <div class="w3-sidebar w3-bar-block w3-theme-l5 w3-card" style="width:200px">
            <h5 class="w3-bar-item">Your Profile</h5>
            ...
            <button class="w3-bar-item w3-button tablink" id="buttonResetPassword" onclick="openCity(event, 'ResetPassword')">Reset Password</button>
            <c:if test="${sessionScope.USERNAME != 'jarvis' && sessionScope.USERNAME != 'stark'}">
                <button class="w3-bar-item w3-button tablink" onclick="openCity(event, 'DeleteProfile')">Delete Profile</button>
            </c:if>
        </div>
        ...
        <div style="margin-left:200px">
            ...
            <div id="ChangeImage" class="w3-container city" style="display:none">
                <h2>Change Image</h2>
                <hr/>
                <img class="w3-circle" src="uploads/users/${sessionScope.USERNAME}" width="200" height="200" onerror="this.src='uploads/default'"/>
            ...
            <div id="ResetPassword" class="w3-container city" style="display:none">
                ...
                <form action="MainController" method="POST">
                    ...
                    <input class="w3-btn w3-theme-l1" type="submit" name="action" value="Reset Password"/>
                </form>
            </div>

            <c:if test="${sessionScope.USERNAME != 'jarvis' && sessionScope.USERNAME != 'stark'}">                    
                <div id="DeleteProfile" class="w3-container city" style="display:none">
                    <h2>Delete Profile</h2>
                    <hr/>
                    <form action="MainController" method="POST">
                        <input type="hidden" name="controller" value="Home"/>
                        <input type="hidden" name="action" value="Delete"/>
                        <input class="w3-btn w3-theme-l1" type="submit" value="Delete My Profile" onclick="return confirm('Are your sure?')"/>
                    </form>   
                </div>              
            </c:if>
        </div>
